...
GLASS_API_AUTH_HEADER=os.getenv('GLASS_API_AUTH_HEADER','Authorization')
GLASS_API_AUTH_SCHEME=os.getenv('GLASS_API_AUTH_SCHEME','Bearer')
GLASS_API_DEBUG_RAW_RESPONSE=os.getenv('GLASS_API_DEBUG_RAW_RESPONSE','true').lower()=='true'
